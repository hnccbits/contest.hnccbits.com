...
const Contest = () => {
  ...
  return (
    <Card className={classes.main}>
      <h1 style={{ paddingBottom: 0.5 + "rem" }}>
            ...
            <div className={classes.details}>
              ...
              */}
                ...
                <IconButton
                  ...
                  href={`https://www.hackerrank.com/${detail.contestCode}`}
                  target="_blank"
                  rel="noopener noreferrer"
                >
                ...
                <IconButton
                  className={classes.icnBtn}
                  aria-label="editorial-link"
                  href={`https://blog.hnccbits.com/${detail.editorialCode}`}
                  target="_blank"
                  rel="noopener noreferrer"
                >
